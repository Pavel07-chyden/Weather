...
const Weather: FC<WeatherProps> = ({ data }) => {
   ...
   const celisius = (data.main.temp - 273.15).toFixed(2)
   return (
            ...
            <div className="level" style={{ alignItems: 'flex-start' }}>
               <div className="level-item has-text-centered">
                  <div>
                     ...
                     <p className="title"><img src={`https://openweathermap.org/img/wn/${data.weather[0].icon}.png`} alt="" /></p>
                  </div>
               </div>
               <div className="level-item has-text-centered">
                  ...
                  <div className="title">
                     ...
                     <p className="mb-2">{celisius}<sup>&#8451;</sup></p>
                  </div>
               </div>
            </div>
            <div className="level-item has-text-centered">
